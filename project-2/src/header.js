...
template.innerHTML = `
  ...
  <header class="hero is-large is-dark p-2">
    <h1 class="title"></h1>
    <h2 class="subtitle">Your go-to page to jam out to EDM and interact with different effects!</h2>
  </header>
`;

// Class for AppHeader Component
class AudioHeader extends HTMLElement
{
    // Constructor
    constructor()
    {
...
// Define the element
customElements.define('audio-header', AudioHeader);